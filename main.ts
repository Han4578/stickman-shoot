...
let difficulty = 1000
forever(function () {
    randomx = randint(-10, 266)
    while (randomx <= 256 && randomx >= 0) {
        randomx = randint(-10, 266)
    }
    randomy = randint(-10, 266)
    while (randomy <= 256 && randomy >= 0) {
        randomy = randint(-10, 266)
    }
    myEnemy = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Enemy)
    myEnemy.follow(character, 20)
    myEnemy.setPosition(randomx, randomy)
    pause(difficulty)
})
forever(function () {
    borgar = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Food)
    borgar.setPosition(randint(10, 150), randint(10, 110))
    pause(10000)
})
forever(function () {
